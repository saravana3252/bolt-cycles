  ...
  return (
    <div>
      ...
      <div className="w-full h-16 p-2 flex justify-between items-center px-8 bg-orange-600 lg:h-16">
        ...
        <div
          id="mobileNav"
          className="fixed top-0 z-50 -right-[50%]  md:bg-red-600 bg-gray-800 w-1/2 h-screen flex flex-col gap-4 items-center transition-all duration-500 ease-in-out lg:hidden"
        >
      ...
      <div className="flex flex-col md:flex-row  lg:mt-10 bg-gray-100 min-h-screen">
        ...
        <button
          className="bg-gray-800 text-orange-400 p-2 mb-2 lg:mb-4 md:hidden"
