  ...
  return (
    <div>
      ...
      <div className="w-full h-16 p-2 flex justify-between items-center px-8 bg-orange-600 lg:h-16">
        ...
        <div
          id="mobileNav"
          className="fixed top-0 z-50 -right-[50%]  md:bg-red-600 bg-gray-800 w-1/2 h-[100%] flex flex-col gap-4 items-center transition-all duration-500 ease-in-out lg:hidden"
        >
